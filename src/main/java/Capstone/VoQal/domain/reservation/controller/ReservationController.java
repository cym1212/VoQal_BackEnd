...
//    public ResponseEntity<AvailableTimesDTO> getAvailableTimes(@RequestBody GetAvailableTimeDTO getAvailableTimeDTO) {
...
//    public ResponseEntity<MessageDTO> updateReservation(@PathVariable Long reservationId, @RequestBody UpdateReservationDTO updateReservationDTO) {
//        reservationService.updateReservation(reservationId, updateReservationDTO);
//        return ResponseEntity.status(HttpStatus.OK).body(MessageDTO.builder().message("성공적으로 수정되었습니다.").build());
//    }
//
//    @DeleteMapping("/{reservationId}")
//    public ResponseEntity<MessageDTO> deleteReservation(@PathVariable Long reservationId) {
//        reservationService.deleteReservation(reservationId);
//        return ResponseEntity.status(HttpStatus.OK).body(MessageDTO.builder().message("성공적으로 삭제되었습니다.").build());
//    }
//}
...
public class ReservationController {
    ...
    public ResponseEntity<List<ReservationResponseDetailsDTO>> getAllReservations() {
